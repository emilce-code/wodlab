...
async function getWorkoutLevels(): Promise<WorkoutLevel[]> {
  const response = await authenticatedApiFetch("/workouts/levels");
...
export default async function NewWorkoutPage() {
  ...
  return (
    <main className="min-h-screen bg-zinc-50 px-4 py-6 text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100 sm:px-6 sm:py-8">
